...
readonly -a invocation_override_names=(
  ...
  PLEDGE_CASH_PROTOCOL_GOVERNANCE
...
[[ -n "$private_key" ]] || fail "set PLEDGE_CASH_DEPLOYER_PRIVATE_KEY or PRIVATE_KEY"
: "${PLEDGE_CASH_DETERMINISTIC_DEPLOYER_OWNER:?Set PLEDGE_CASH_DETERMINISTIC_DEPLOYER_OWNER}"
: "${PLEDGE_CASH_PROTOCOL_GOVERNANCE:?Set PLEDGE_CASH_PROTOCOL_GOVERNANCE}"
...
require_address PLEDGE_CASH_PROTOCOL_GOVERNANCE "$PLEDGE_CASH_PROTOCOL_GOVERNANCE"
