...
checkpoint="${PLEDGE_CASH_VNEXT_DEPLOYMENT_PATH:-deployments/31337.diamond-vnext.local.json}"
scenario="script/BoardroomDiamondVNextLocal.s.sol:BoardroomDiamondVNextLocal"
...
echo "vNext Anvil scenario complete"
