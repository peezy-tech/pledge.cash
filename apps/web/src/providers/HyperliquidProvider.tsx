...
export const HyperliquidContext = createContext<HyperliquidContextType | null>(
  null,
)
...
export const HyperliquidProvider: React.FC<HyperliquidProviderProps> = ({
  children,
}) => {
  ...
  useEffect(() => {
    try {
      ...
      console.error(
        'Error initializing Hyperliquid transport/info client:',
        err,
      )
      setError(
        err instanceof Error
          ? err.message
          : 'Failed to initialize Hyperliquid clients',
      )
    }
  }, [])
  ...
  const refreshClients = useCallback(() => {
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : 'Failed to refresh Hyperliquid clients',
      )
    }
