  ...
  return (
    <>
      ...
      {histories.length > 0 || catalogEntry?.distribution ? (
        <RuledSection>
          <SectionHeading title="Participation history" description="Each bond, sale, curve, airdrop, and migrated market stays separate so incompatible quote and payment tokens are never added together." />
