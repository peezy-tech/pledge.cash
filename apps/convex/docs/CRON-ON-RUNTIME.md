[Back to Components](https://www.convex.dev/components) ![Crons hero image](https://www.convex.dev/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcrons.efef7e81.png&w=1536&q=75)
...
The design of this component is based on the Cronvex demo app that's described in [this Stack post](https://stack.convex.dev/cron-jobs).
