...
Open the project’s `Participate` section. The app shows only the routes discovered for that Boardroom: fixed-price sales, bonding curves, airdrops, and AMM markets. Review whether the route is live, then connect the wallet that will act.
